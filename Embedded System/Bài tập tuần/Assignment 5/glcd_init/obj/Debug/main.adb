M:main
F:G$delay_us$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$delay$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_Command$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_Data$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_Init$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_ClearAll$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_Plot_Coordinate_Axes$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$GLCD_WriteChar$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fmain$float_long[({0}S:S$f$0_0$0({4}SF:S),Z,0,0)({0}S:S$l$0_0$0({4}SL:S),Z,0,0)]
T:Fmain$__00000000[({0}S:S$quot$0_0$0({2}SI:S),Z,0,0)({2}S:S$rem$0_0$0({2}SI:S),Z,0,0)]
T:Fmain$__00000001[({0}S:S$quot$0_0$0({4}SL:S),Z,0,0)({4}S:S$rem$0_0$0({4}SL:S),Z,0,0)]
T:Fmain$__00000002[({0}S:S$quot$0_0$0({8}SI:S),Z,0,0)({8}S:S$rem$0_0$0({8}SI:S),Z,0,0)]
S:Lmain.GLCD_Plot_Coordinate_Axes$sloc0$0_1$0({1}SB0$0:S),H,0,0
S:Lmain.aligned_alloc$alignment$1_0$53({2}SI:U),P,0,0
S:G$temp$0_0$0({1}SC:U),P,0,0
S:Lmain.delay_us$t$1_0$70({1}SC:U),R,0,0,[]
S:Lmain.delay$k$1_0$72({2}SI:U),R,0,0,[r6,r7]
S:Lmain.delay$i$1_0$73({2}SI:S),R,0,0,[r4,r5]
S:Lmain.delay$j$1_0$73({2}SI:S),R,0,0,[r2,r3]
S:Lmain.GLCD_Command$Command$1_0$76({1}SC:U),R,0,0,[]
S:Lmain.GLCD_Data$Data$1_0$78({1}SC:U),R,0,0,[]
S:Lmain.GLCD_ClearAll$i$1_0$83({2}SI:S),R,0,0,[r6,r7]
S:Lmain.GLCD_ClearAll$j$1_0$83({2}SI:S),R,0,0,[r4,r5]
S:Lmain.GLCD_Plot_Coordinate_Axes$i$1_0$89({2}SI:S),R,0,0,[r6,r7]
S:Lmain.GLCD_Plot_Coordinate_Axes$j$1_0$89({2}SI:S),R,0,0,[r3,r4]
S:Lmain.GLCD_Plot_Coordinate_Axes$Page$1_0$89({2}SI:U),R,0,0,[]
S:Lmain.GLCD_Plot_Coordinate_Axes$Y_address$1_0$89({2}SI:U),R,0,0,[]
S:Lmain.GLCD_Plot_Coordinate_Axes$Page_inc$1_0$89({4}SF:S),R,0,0,[]
S:Lmain.GLCD_WriteChar$page_no$1_0$99({1}SC:U),R,0,0,[r7]
S:Lmain.GLCD_WriteChar$column$1_0$100({2}SI:U),R,0,0,[r4,r3]
S:Lmain.GLCD_WriteChar$Page$1_0$100({2}SI:U),R,0,0,[]
S:Lmain.GLCD_WriteChar$Y_address$1_0$100({2}SI:U),R,0,0,[r2,r7]
S:Lmain.GLCD_WriteChar$Page_inc$1_0$100({4}SF:S),P,0,0
...
S:G$div$0_0$0({2}DF,ST__00000000:S),C,0,0
S:G$ldiv$0_0$0({2}DF,ST__00000001:S),C,0,0
S:G$lldiv$0_0$0({2}DF,ST__00000002:S),C,0,0
...
S:G$GLCD_Command$0_0$0({2}DF,SV:S),C,0,0
S:G$GLCD_Data$0_0$0({2}DF,SV:S),C,0,0
S:G$GLCD_Init$0_0$0({2}DF,SV:S),C,0,0
S:G$GLCD_ClearAll$0_0$0({2}DF,SV:S),C,0,0
S:G$GLCD_Plot_Coordinate_Axes$0_0$0({2}DF,SV:S),C,0,0
S:G$GLCD_WriteChar$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SV:S),C,0,0
S:G$font$0_0$0({135}DA27d,DA5d,SC:U),D,0,0

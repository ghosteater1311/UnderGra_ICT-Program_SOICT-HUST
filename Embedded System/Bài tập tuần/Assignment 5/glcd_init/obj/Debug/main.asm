...
;--------------------------------------------------------
	.area BSEG    (BIT)
Lmain.GLCD_Plot_Coordinate_Axes$sloc0$0_1$0==.
...
_temp::
	.ds 1
Lmain.GLCD_WriteChar$Page_inc$1_0$100==.
_GLCD_WriteChar_Page_inc_65536_100:
	.ds 4
;--------------------------------------------------------
...
;	main.c:158: }
	C$main.c$158$1_0$89 ==.
	XG$GLCD_Plot_Coordinate_Axes$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'GLCD_WriteChar'
;------------------------------------------------------------
	G$GLCD_WriteChar$0$0 ==.
	C$main.c$159$1_0$100 ==.
...
_GLCD_WriteChar:
	mov	r7,dpl
	C$main.c$162$2_0$100 ==.
;	main.c:162: float Page_inc=0.5;
	mov	r0,#_GLCD_WriteChar_Page_inc_65536_100
	clr	a
	movx	@r0,a
	inc	r0
	movx	@r0,a
	...
	inc	r0
	movx	@r0,a
	C$main.c$164$1_0$100 ==.
;	main.c:164: CS1 = 1;
;	assignBit
	setb	_P0_4
	C$main.c$165$1_0$100 ==.
;	main.c:165: CS2 = 0;
;	assignBit
	clr	_P0_3
	C$main.c$166$1_0$100 ==.
;	main.c:166: GLCD_Command((0xB8)+page_no);
	mov	a,#0xb8
	add	a,r7
	mov	dpl,a
	lcall	_GLCD_Command
	C$main.c$167$1_0$100 ==.
;	main.c:167: GLCD_Command(0x40);
	mov	dpl,#0x40
	lcall	_GLCD_Command
	C$main.c$168$3_0$102 ==.
...
;	main.c:171: if((Y_address+1)%64==0)
	...
	ljmp	00102$
00118$:
	C$main.c$173$2_0$100 ==.
;	main.c:173: CS1 = !CS1; CS2 = !CS2;
	push	ar2
	push	ar7
	cpl	_P0_4
	cpl	_P0_3
	C$main.c$174$2_0$100 ==.
...
;	main.c:175: Page_inc=Page_inc+0.5;
	...
	pop	ar4
	pop	ar7
	C$main.c$168$2_0$100 ==.
;	main.c:168: for(column=0;column<5;column++)
	pop	ar7
	pop	ar2
	C$main.c$175$3_0$102 ==.
;	main.c:175: Page_inc=Page_inc+0.5;
00102$:
	C$main.c$177$3_0$102 ==.
;	main.c:177: Y_address++;
	inc	r2
	cjne	r2,#0x00,00119$
	inc	r7
00119$:
	C$main.c$168$2_0$101 ==.
;	main.c:168: for(column=0;column<5;column++)
	inc	r4
	cjne	r4,#0x00,00120$
	inc	r3
